...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss txd") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "maisha") || (event.body.toLowerCase() == "riya")) {
  ...
  if ((event.body.toLowerCase() == "@Muhid Islam Sunny ") || (event.body.toLowerCase() == "sunny")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস মুহিত'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS [ / ] • ♡Xx~(𝗲ṁпἶ)~xX♡ 𝗯𝗼𝘁", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "sunny") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "mon kharap") || (event.body.toLowerCase() == "tmr ki mon kharap") || (event.body.toLowerCase() == "তোমার মন খারাপ") ) {
  ...
  if (event.body.indexOf("/maisa") == 0 || (event.body.indexOf("/bot") == 0)) {
    var msg = {
      body: `${name}, ${rand}`
    }
